...
import { HeroVisual } from '@/components/server/solutions/enterprise/EnterpriseVisuals';
...
// Lazy load visuals
const OutcomesVisual = React.lazy(() => import('@/components/server/solutions/enterprise/EnterpriseVisuals').then(m => ({ default: m.OutcomesVisual })));
const ProblemVisual = React.lazy(() => import('@/components/server/solutions/enterprise/EnterpriseVisuals').then(m => ({ default: m.ProblemVisual })));
const SolutionVisual = React.lazy(() => import('@/components/server/solutions/enterprise/EnterpriseVisuals').then(m => ({ default: m.SolutionVisual })));
