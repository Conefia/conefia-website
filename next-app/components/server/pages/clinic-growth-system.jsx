...
import SeoLandingPage, { SolutionHero } from '@/components/client/solutions/SeoLandingPage';
import { HeroVisual } from '@/components/server/solutions/clinic-growth/ClinicGrowthVisuals';
import Seo from '@/components/client/Seo';
import { SectionSkeleton, DarkSectionSkeleton } from '@/components/server/loading/SkeletonLoader';

// Lazy load below-the-fold components
const SolutionMetrics = React.lazy(() => import('@/components/client/solutions/SeoLandingPage').then(m => ({ default: m.SolutionMetrics })));
const SolutionTrustedBy = React.lazy(() => import('@/components/client/solutions/SeoLandingPage').then(m => ({ default: m.SolutionTrustedBy })));
const SolutionProblem = React.lazy(() => import('@/components/client/solutions/SeoLandingPage').then(m => ({ default: m.SolutionProblem })));
const SolutionDetails = React.lazy(() => import('@/components/client/solutions/SeoLandingPage').then(m => ({ default: m.SolutionDetails })));
const SolutionProcess = React.lazy(() => import('@/components/client/solutions/SeoLandingPage').then(m => ({ default: m.SolutionProcess })));
const SolutionOutcomes = React.lazy(() => import('@/components/client/solutions/SeoLandingPage').then(m => ({ default: m.SolutionOutcomes })));
const SolutionProof = React.lazy(() => import('@/components/client/solutions/SeoLandingPage').then(m => ({ default: m.SolutionProof })));
const SolutionFAQ = React.lazy(() => import('@/components/client/solutions/SeoLandingPage').then(m => ({ default: m.SolutionFAQ })));
const SolutionFinalCta = React.lazy(() => import('@/components/client/solutions/SeoLandingPage').then(m => ({ default: m.SolutionFinalCta })));

// Lazy load visuals and other components
const AttributionVisual = React.lazy(() => import('@/components/server/solutions/clinic-growth/ClinicGrowthVisuals').then(m => ({ default: m.AttributionVisual })));
const BrokenJourneyVisual = React.lazy(() => import('@/components/server/solutions/clinic-growth/ClinicGrowthVisuals').then(m => ({ default: m.BrokenJourneyVisual })));
const SolutionDashboardVisual = React.lazy(() => import('@/components/server/solutions/clinic-growth/ClinicGrowthVisuals').then(m => ({ default: m.SolutionDashboardVisual })));
const ProcessVisual = React.lazy(() => import('@/components/server/solutions/clinic-growth/ClinicGrowthVisuals').then(m => ({ default: m.ProcessVisual })));
const OutcomesVisual = React.lazy(() => import('@/components/server/solutions/clinic-growth/ClinicGrowthVisuals').then(m => ({ default: m.OutcomesVisual })));
const RoadmapPreviewVisual = React.lazy(() => import('@/components/server/solutions/clinic-growth/ClinicGrowthVisuals').then(m => ({ default: m.RoadmapPreviewVisual })));
const BrandCarousel = React.lazy(() => import('@/components/client/landing/BrandCarousel'));
