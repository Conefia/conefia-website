...
import TestimonialSlider from '@/components/client/landing/TestimonialSlider';
...
import { BreadcrumbStructuredData, ServiceStructuredData } from '@/components/server/StructuredData';
import { Accordion, AccordionContent, AccordionItem, AccordionTrigger } from "@/components/server/ui/accordion";
import { cn } from "@/components/client/lib/utils";
  ...
  <section className="py-24 bg-[#FAFAFA]">
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <Reveal delay={0.2} className="mt-8 text-center">
        <p className="text-sm text-gray-500">Still unsure? <Link href={createPageUrl('Book')} className="text-[#1a1a1a] font-bold underline decoration-[#DBFE01] decoration-2 underline-offset-2 hover:text-black hover:decoration-4 transition-all">Book a quick chat</Link></p>
      </Reveal>
    </div>
  </section>;
