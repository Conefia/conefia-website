...
export default function FAQSection({ reduceMotion }) {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: (
        <>
          Yes — agents, RAG, and workflow automation. We prioritize production readiness: evaluation, guardrails, and monitoring so it performs beyond a demo. <Link href={createPageUrl('ai-saas-mvp-launch')} className="text-[#1a1a1a] font-bold hover:text-[#a8c600] transition-colors underline">AI SaaS MVP Launch</Link>
        </>
      )
    },
    {
      ...
      answer: (
        <>
          Yes. We use privacy-first workflows and healthcare-appropriate handling for systems that touch patient data. <Link href={createPageUrl('clinic-growth-system')} className="text-[#1a1a1a] font-bold hover:text-[#a8c600] transition-colors underline">Clinic Growth System</Link>
        </>
      )
    },
    {
