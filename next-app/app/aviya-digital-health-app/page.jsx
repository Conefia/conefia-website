...
export const metadata = {
  title: "Aviya Telemed Case Study - Telemedicine MVP | Conefia",
...
export default function AviyaPage() {
  const scrollToContact = createPageUrl('Home') + '#contact';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-[#FAFAFA]">
      ...
      <section className="relative pt-32 pb-20 overflow-hidden">
        ...
        {/* Abstract shape - static for server, could be animated client side if strictly needed, but better static for perf */}
        <div className="absolute bottom-20 left-10 w-96 h-96 bg-sky-500/20 rounded-full blur-3xl opacity-40" />
