...
import StarCanvas from '@/components/visual/StarCanvas';
...
export default function CaseStudiesSection({ reduceMotion }) {
  ...
  return (
    <section ref={ref} id="case-studies" className="py-20 md:py-32 relative overflow-hidden bg-[#2F2F2F]">
      ...
      {/* Star Dust */}
      <StarCanvas count={isMobile ? 60 : 300} />
                      ...
                      <div className="p-8 md:p-10">
                        <div className="flex items-start justify-between mb-4">
                          <div className="flex-1">
                            <h3 className="text-xl font-bold mb-2 transition-colors" style={{ color: 'white', WebkitTextFillColor: 'white', backgroundImage: 'none' }}>
                              {study.client}
                            </h3>
                            <a
                            href={study.url}
