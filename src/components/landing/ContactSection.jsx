              ...
              <div className="space-y-6 relative z-10 py-6 sm:py-8">
                ...
                <a href="mailto:info@conefia.com">
                  ...
                  >
                    <Button
                      variant="outline"
                      className="w-full h-12 sm:h-14 rounded-full border-2 border-white/30 bg-white/5 hover:bg-white/10 hover:border-white/50 text-white font-semibold text-sm sm:text-base transition-all shadow-lg hover:shadow-xl"
                    >
