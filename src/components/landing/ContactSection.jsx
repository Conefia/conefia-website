          ...
          >
            ...
            >
              Ready to <span className="relative inline-block">
                ...
                <motion.span
                  className="absolute -bottom-2 left-0 right-0 h-3 bg-white -rotate-1"
                  initial={{ scaleX: 0 }}
            ...
            >
              {trustItems.map((item, index) => (
                <motion.div
                  ...
                  className="flex items-center gap-2 px-4 py-2.5 rounded-full bg-white backdrop-blur-sm shadow-lg border-2 border-[#1a1a1a]/40 hover:border-[#1a1a1a] hover:bg-white hover:shadow-2xl transition-all group cursor-default"
                >
