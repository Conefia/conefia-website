        ...
        >
          {PERSONAS.map((persona) => (
            <a
              ...
              className={`px-4 py-2 rounded-full text-sm font-semibold transition-all duration-300 border inline-block cursor-pointer no-underline ${selectedPersonaId === persona.id
            ...
            <div className="relative">
              ...
              <div className="relative bg-white rounded-3xl p-8 md:p-10 h-full border border-[#DBFE01] shadow-2xl shadow-[#DBFE01]/10 overflow-hidden ring-1 ring-[#DBFE01]/20">
                ...
                <div className="mt-10 flex flex-col sm:flex-row gap-4">
                  <Link
                    href={createPageUrl(selectedPersona.destination)}
