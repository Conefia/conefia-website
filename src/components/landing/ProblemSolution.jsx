                  ...
                  <ul className="space-y-5">
                    ...
                    <motion.li
                      ...
                      className="flex items-start gap-3">
                        ...
                        <span className="text-[#1a1a1a] text-base font-normal leading-relaxed">{problem}</span>
                      </motion.li>
                    )}
                  </ul>
                </div>
            ...
            <div className="relative">
              ...
              <div className="relative bg-white rounded-3xl p-8 md:p-10 h-full border border-[#DBFE01] shadow-2xl shadow-[#DBFE01]/10 overflow-hidden ring-1 ring-[#DBFE01]/20">
                ...
                <div className="mt-10 flex flex-col sm:flex-row gap-4">
                    ...
                    onClick={() => handleCtaClick('primary')} className="bg-slate-950 px-8 py-4 text-sm font-bold text-center rounded-xl btn-primary flex items-center justify-center gap-2 shadow-[0_1px_0_0_rgba(255,255,255,0.3)_inset,0_4px_12px_rgba(219,254,1,0.25)] hover:shadow-[0_1px_0_0_rgba(255,255,255,0.4)_inset,0_6px_20px_rgba(219,254,1,0.35)]">
