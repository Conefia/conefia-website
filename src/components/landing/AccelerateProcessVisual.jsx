...
export default function AccelerateProcessVisual({ reduceMotion }) {
  ...
  return (
    <div className="relative w-full max-w-md lg:max-w-4xl ml-auto p-4 lg:-mr-16 lg:pr-8 bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl overflow-hidden">
      {/* Background Glow */}
