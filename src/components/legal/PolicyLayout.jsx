      ...
      <div className="relative overflow-hidden pt-28 pb-20">
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <motion.h1
            ...
            className="text-5xl md:text-6xl lg:text-7xl font-extrabold mb-4 leading-[1.1] text-center md:text-left gradient-heading gradient-heading--glow"
          >
            {title}
          </motion.h1>
    ...
    <ul className="space-y-2 mt-2">
      {items.map((item, i) => (
        <li key={i} className="flex items-start gap-2.5 text-sm text-gray-600">
          <span className="mt-2 w-2 h-2 rounded-full bg-[#b8d400] flex-shrink-0 ring-2 ring-[#DBFE01]/40 shadow-[0_0_6px_rgba(185,212,0,0.7)]" />
          <span>{item}</span>
        </li>
      ))}
    </ul>
