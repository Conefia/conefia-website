  ...
  return (
    <section className="relative min-h-[90vh] flex items-center pt-20 overflow-hidden bg-[#0B1020]">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 py-16 md:py-24">
        <div className="mb-8">
          <Breadcrumbs items={[{ label: 'Solutions', path: '/#playbook' }, { label: title }]} theme="dark" />
        </div>
        ...
        {layout === 'split' ? (
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="text-left">
              ...
              >
                <Link href="/contact" className="btn-primary px-8 py-4 rounded-full text-base font-bold flex items-center justify-center gap-2 shadow-lg shadow-[#DBFE01]/20 hover:scale-105 transition-transform">
                  {primaryCta}
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
      <div className="grid lg:grid-cols-2 gap-16 items-center">
        ...
        <Reveal delay={0.2} className="order-1 lg:order-2">
          ...
          <Link href="/contact" className="btn-primary px-8 py-4 rounded-full text-base font-bold inline-flex items-center gap-2 shadow-lg shadow-[#DBFE01]/20 hover:scale-105 transition-transform">
            {primaryCta}
            <ArrowRight className="w-5 h-5" />
          </Link>
        </Reveal>
  ...
  <section className="py-24 bg-[#FAFAFA]">
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <Reveal delay={0.2} className="mt-8 text-center">
        <p className="text-sm text-gray-500">Still unsure? <Link href="/contact" className="text-[#1a1a1a] font-bold underline decoration-[#DBFE01] decoration-2 underline-offset-2 hover:text-black hover:decoration-4 transition-all">Book a quick chat</Link></p>
      </Reveal>
    </div>
  </section>
);
