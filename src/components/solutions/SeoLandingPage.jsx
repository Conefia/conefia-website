    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
      ...
      <Reveal className="mb-14 flex flex-col items-center text-center">
        ...
        <h2 className="mt-5 text-3xl md:text-4xl lg:text-5xl font-extrabold leading-tight max-w-3xl text-center">
          <span style={{background: 'linear-gradient(to right, #1a1a1a 0%, #6b7280 50%, #DBFE01 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text'}}>{title || "Why most AI MVPs get delayed and miss pilots and revenue"}</span>
        </h2>
      </Reveal>
