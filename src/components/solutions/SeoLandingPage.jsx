      ...
      <Reveal delay={0.3}>
        <div className="flex flex-wrap justify-center gap-3 mt-10">
          {[
            ...
            <Link key={item.label} to={createPageUrl('Book')} className="flex items-center gap-2 bg-[#1a1a1a]/10 hover:bg-[#1a1a1a]/20 rounded-full px-4 py-2 text-xs font-bold text-[#1a1a1a]/80 tracking-wide transition-colors cursor-pointer">
              <span>{item.icon}</span>
