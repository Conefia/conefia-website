    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
      <Reveal>
        ...
        <div className="flex flex-col items-center gap-4">
          <Link
          to={createPageUrl('Book')}
          className="px-8 py-4 rounded-xl text-base font-bold flex items-center justify-center gap-2 bg-[#1a1a1a] text-white hover:bg-black shadow-[0_4px_12px_rgba(0,0,0,0.25)] hover:shadow-[0_6px_20px_rgba(0,0,0,0.35)] hover:-translate-y-0.5 transition-all duration-300">
