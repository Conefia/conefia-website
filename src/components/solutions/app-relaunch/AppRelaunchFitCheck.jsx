    ...
    <section className="py-20 bg-white relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <motion.div
          ...
          <p className="text-[#1a1a1a]/80 mx-auto text-base font-normal leading-relaxed max-w-2xl">This is for teams with a live app that already has users, installs, reviews, or product history — but retention, growth, ratings, or store performance are not where they should be.
