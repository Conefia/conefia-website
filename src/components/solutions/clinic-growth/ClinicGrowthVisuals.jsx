...
// Hero Visual: Animated Connected Patient Journey
export const HeroVisual = () => {
  const steps = [
    { icon: Search, label: "Discovery", desc: "Finds you on Google", emoji: "🔍", color: "from-blue-500/20 to-blue-600/10", border: "border-blue-400/30", glow: "shadow-blue-500/20" },
    { icon: Globe, label: "Decision", desc: "Visits your website", emoji: "🌐", color: "from-violet-500/20 to-violet-600/10", border: "border-violet-400/30", glow: "shadow-violet-500/20" },
    { icon: FileText, label: "Intake", desc: "Fills forms digitally", emoji: "📋", color: "from-amber-500/20 to-amber-600/10", border: "border-amber-400/30", glow: "shadow-amber-500/20" },
    { icon: CalendarCheck, label: "Booking", desc: "Schedules appointment", emoji: "✅", color: "from-emerald-500/20 to-emerald-600/10", border: "border-emerald-400/30", glow: "shadow-emerald-500/20" },
  ];
