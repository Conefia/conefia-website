  ...
  return (
    <section className="py-24 bg-[#f9ffe0] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <span className="bg-[#1a1a1a] text-[#DBFE01] px-4 py-2 text-xs font-bold uppercase tracking-widest rounded-full inline-flex items-center gap-2 mb-5">
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="flex flex-col sm:flex-row items-center justify-between gap-6 bg-white border border-[#c5e000] rounded-2xl px-8 py-6"
        >
