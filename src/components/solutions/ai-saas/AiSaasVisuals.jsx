...
const METRIC_CARDS = [
  ...
  { val: "Active", label: "First Pilots", sub: "Real users testing", icon: Users, color: "text-[#1a1a1a]", bg: "bg-[#DBFE01]", border: "border-[#DBFE01]", accent: "from-white/20 to-transparent", valColor: "text-[#1a1a1a]" },
    ...
    >
      ...
      <div className="space-y-3 mb-6 relative z-10">
        {sections.map((section, i) => (
          <motion.div
            ...
            className="p-3 bg-gray-50 rounded-lg border border-gray-200 group hover:bg-white transition-colors"
          >
            <div className="flex items-center justify-between mb-1.5">
              ...
              <motion.span
                ...
                className="text-[10px] font-bold text-white bg-slate-950 px-2 py-0.5 rounded"
              >
                {section.status}
              </motion.span>
            </div>
            <motion.div
              ...
              className="h-1 bg-slate-950 rounded-full"
            />
          </motion.div>
        ))}
      </div>
      ...
      >
        <motion.div 
          ...
          className="bg-slate-950 text-white font-bold px-6 py-2.5 rounded-full shadow-[0_12px_24px_rgba(0,0,0,0.35)] text-xs border-2 border-white/50 tracking-wide"
        >
          🚀 Ship in 8–12 Weeks
        </motion.div>
      </motion.div>
