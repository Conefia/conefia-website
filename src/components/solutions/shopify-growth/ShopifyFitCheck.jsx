    ...
    <section className="py-20 bg-white relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <motion.div
          ...
          <p className="text-[#1a1a1a]/80 mx-auto text-base font-normal leading-relaxed max-w-2xl">This is for brands that want to grow faster — or launch smarter from day one.
