    ...
    <div className="min-h-screen bg-[#0B1020] overflow-hidden">
      ...
      <section ref={heroRef} className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 md:pt-24 pb-24 text-center">
          ...
          <motion.h1
            {...fadeUp(0.2)} className="mb-6 text-3xl font-bold text-center leading-tight md:text-left gradient-heading gradient-heading--glow">
            ...
            {pillars.map((p, i) => {
              ...
              return (
                <motion.div
                  ...
                  <div>
                   <h3 className="text-lg font-bold mb-2 gradient-heading gradient-heading--glow">{p.title}</h3>
