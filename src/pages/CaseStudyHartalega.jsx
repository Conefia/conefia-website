...
import { ArrowLeft, CheckCircle, TrendingUp, DollarSign, Target, ExternalLink } from 'lucide-react';
          ...
          <div className="space-y-12">
            ...
            <div className="glass-card rounded-3xl p-8 md:p-10">
              ...
              <p className="text-[#1a1a1a]/70 text-lg leading-relaxed">
                Create a credible, execution-ready AI roadmap and prove value quickly through real PoCs—not slideware.
              </p>
            </div>
            ...
            <div className="glass-card rounded-3xl p-8 md:p-10">
              ...
              <p className="text-[#1a1a1a]/70 text-lg leading-relaxed">
                Built a 3-year AI & digital transformation strategy, then delivered PoCs across predictive maintenance, predictive quality, and AI agents for process optimization with clear evaluation criteria and ROI measurement.
              </p>
            </div>
            ...
            <div className="glass-card rounded-3xl p-8 md:p-10 bg-gradient-to-br from-[#DBFE01]/10 to-transparent border-[#DBFE01]/20">
              ...
              <div className="space-y-4">
                {[
                  'Idea → validated PoCs in 3 months',
                  '5× ROI (reported)',
                ].map((result, i) => (
