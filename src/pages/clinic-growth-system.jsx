    ...
    <SeoLandingPage>
      ...
      <Suspense fallback={<SectionSkeleton />}>
        <SolutionProof 
          ...
          imageUrl="https://media.base44.com/images/public/695311d1426e4dadf87a8d53/859d09ca8_pexels-tima-miroshnichenko.jpg"
          imageAlt="Healthcare professional working with patient growth strategy"
          whyBuildItems={[
          ...
          techStackTitle="Tools behind better clinic growth"
          techStackDesc="Proven platforms we use to build, track, and grow your patient journey — without breaking your existing stack."
          techStackLogos={[
