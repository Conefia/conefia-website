          ...
          <div className="space-y-12">
            ...
            <div className="glass-card rounded-3xl p-8 md:p-10">
              ...
              <p className="text-[#1a1a1a]/70 text-lg leading-relaxed">
                Launch a new e-commerce brand end-to-end (store + brand + acquisition engine) and scale efficiently.
              </p>
            </div>
            ...
            <div className="glass-card rounded-3xl p-8 md:p-10">
              ...
              <p className="text-[#1a1a1a]/70 text-lg leading-relaxed">
                Delivered all 4 phases: Shopify build, conversion optimization, brand identity, analytics/tracking, and full-funnel growth across Meta, TikTok, and Google.
              </p>
            </div>
            ...
            <div className="glass-card rounded-3xl p-8 md:p-10 bg-gradient-to-br from-[#DBFE01]/10 to-transparent border-[#DBFE01]/20">
              ...
              <div className="space-y-4">
                {[
                  '50% month-on-month revenue growth',
                  '1,500+ paying customers in 3 months',
                  'AED 32 CAC on digital marketing',
                ].map((result, i) => (
