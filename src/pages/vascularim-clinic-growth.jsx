  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-[#FAFAFA]">
      <Seo 
        ...
        canonical="https://conefia.com/vascularim-clinic-growth"
      />
      ...
      <section className="relative pt-32 pb-20 overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          <h1 className="text-3xl font-bold mb-6 leading-tight" style={{ color: '#1a1a1a', WebkitTextFillColor: '#1a1a1a', backgroundImage: 'none' }}>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <Section delay={0.4}>
            ...
            <button 
              ...
              className="btn-primary px-5 py-2.5 rounded-lg text-base font-bold inline-flex items-center gap-2 shadow-[0_1px_0_0_rgba(255,255,255,0.3)_inset,0_2px_8px_rgba(219,254,1,0.2)] hover:shadow-[0_1px_0_0_rgba(255,255,255,0.4)_inset,0_0_15px_rgba(219,254,1,0.35),0_4px_12px_rgba(219,254,1,0.25)] hover:scale-105 active:scale-95 transition-all duration-300"
            >
              Book roadmap call
