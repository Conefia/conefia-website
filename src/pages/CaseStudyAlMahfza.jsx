  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-[#FAFAFA]">
      ...
      <section className="relative pt-32 pb-20 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-emerald-500/5 to-lime-500/5" />
          ...
          <div className="space-y-12">
            ...
            <div className="glass-card rounded-3xl p-8 md:p-10">
              ...
              <p className="text-[#1a1a1a]/70 text-lg leading-relaxed">
                After 1 year and multiple vendors, the client still couldn't launch a stable mobile app—plus regulatory complexity created execution risk.
              </p>
            </div>
            ...
            <div className="glass-card rounded-3xl p-8 md:p-10">
              ...
              <p className="text-[#1a1a1a]/70 text-lg leading-relaxed">
                Took ownership of delivery, rebuilt the app execution plan, shipped a fully functioning, optimized mobile app, and guided the team through U.S. money transfer app compliance considerations (requirements mapping + implementation alignment).
              </p>
            </div>
            ...
            <div className="glass-card rounded-3xl p-8 md:p-10 bg-gradient-to-br from-[#DBFE01]/10 to-transparent border-[#DBFE01]/20">
              ...
              <div className="space-y-4">
                {[
                  'Production-ready app delivered in 60 days',
                  'Reduced vendor cycle time from ~12 months to 2 months (~83% faster)',
                ].map((result, i) => (
