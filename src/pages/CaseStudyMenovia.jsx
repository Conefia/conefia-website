...
export default function CaseStudyMenovia() {
          ...
          <div className="space-y-12">
            ...
            <div className="glass-card rounded-3xl p-8 md:p-10">
              ...
              <p className="text-[#1a1a1a]/70 text-lg leading-relaxed">
                Sharpen positioning, validate the niche, and ship an MVP fast—while building a credible digital presence for growth.
              </p>
            </div>
            ...
            <div className="glass-card rounded-3xl p-8 md:p-10">
              ...
              <div className="space-y-4 text-[#1a1a1a]/70 text-lg leading-relaxed">
                <p>Conducted market + consumer research to refine the offering and pinpoint the niche</p>
                <p>Ran rapid prototyping to validate concepts and finalize MVP scope</p>
                <p>Built the women's health AI agent, website, and AI-integrated mobile app</p>
                <p>Established the digital presence foundation: created/optimized social profiles and produced engaging marketing content to support launch and growth readiness</p>
              </div>
            </div>
            ...
            <div className="glass-card rounded-3xl p-8 md:p-10 bg-gradient-to-br from-[#DBFE01]/10 to-transparent border-[#DBFE01]/20">
              ...
              <div className="space-y-4">
                {[
                  'MVP ready in 3 months (vs. 9-month plan) → ~66% faster time-to-market',
                  'Growth-ready foundation established: product + website + social presence + launch content in place',
                ].map((result, i) => (
